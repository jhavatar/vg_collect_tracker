...
import io.chthonic.vg_track.business.actions.AuthActions
import io.chthonic.vg_track.data.model.AppState
import io.chthonic.vg_track.data.model.Auth
...
//                }
    ...
    private val signedInChangePublisher = object: StateService.AppStateChangePublisher<Boolean>() {
    ...
    private fun update(firebaseAuth: FirebaseAuth) {
        val firebaseUser = firebaseAuth.currentUser
    ...
    private fun signIn(user: FirebaseUser) {
        ...
        stateService.dispatch(authActions.signIn(User(user.uid,
                user.displayName ?: "",
                user.email ?: "",
